...
summary: Cathay Pacific rebrands, using data streaming with Apache Kafka to transform
  into a travel ecosystem, enhancing customer experiences and operations.
...
created: 2025-03-20
description: Blog about architectures, best practices and use cases for data streaming,
  analytics, hybrid cloud infrastructure, internet of things, crypto, and more
tags:
- data_streaming
- apache_kafka
type: null
permalink: resources/cathay-from-premium-airline-to-integrated-travel-ecosystem-with-data-streaming
---
