...
const currentFolder = "De project mlop2"; // Phải được thay thế bởi Templater khi tạo file
...
const currentFolder = "De project mlop2";
...
where tags = "resources/De project mlop2"
